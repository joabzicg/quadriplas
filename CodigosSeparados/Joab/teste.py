...
T1_p = [69000, 500000,4320,5050]
T2_p= [500000,230000,432000,505000]
T3_p = [230000,69000,402000,607000]
...
#CARGAS EM DERIVAÇÃO
Zc1 = 8530 + 1j*w*52
Zc2= 1050.55 + 1j*w*6.02
Zc3 = 505 + 1j*w*2.7

#paramêtros da LINHA '1_2_3', '4_5' e 6 [R, L, C]:
LT1_LT2 = [dLT1_2*0.172,dLT1_2*2.18e-3,dLT1_2*0.0136e-6]
LT3 = [dLT3*0.172,dLT3*2.18e-3,dLT3*0.0136e-6]
LT4 = [dLT4*0.172,dLT4*2.18e-3,dLT4*0.0136e-6]
...
LT3 = M_Linha(LT3) #Terceira Linha
LT4 = M_Linha(LT4) #Quarta Linha
...
matriz2 = Associar_Matriz_em_Cascata (matriz1, paralel_LT1_2) #Matriz Transmissão até a carga 1
